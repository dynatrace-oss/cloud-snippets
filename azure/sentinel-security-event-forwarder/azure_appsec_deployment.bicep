...
var uniqueStr = uniqueString('${resourceGroup().id}-sentinel')
    ...
    siteConfig: {
      appSettings: [
        ...
        }
        {
          ...
          value: 'https://github.com/dynatrace-oss/cloud-snippets/raw/refs/heads/main/azure/sentinel-security-event-forwarder/sentinel_function_app.zip'
        }
      ]
      numberOfWorkers: 1
